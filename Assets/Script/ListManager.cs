...
public class ListManager : MonoBehaviour
{
    ...
    public void addItem(string uid)
    {
        ...
        {
            ItemPrefab.transform.Find("uid").GetComponent<Text>().text = uid;
    ...
    public void displayConnectionState(string uid, bool isConnected)
    {
        ...
        if (isConnected)
        {
            GetPrefab.transform.Find("uid").GetComponent<Text>().color = new Color(0.0f, 0.0f, 0.0f);
        }
        else
        {
            GetPrefab.transform.Find("uid").GetComponent<Text>().color = new Color(1.0f, 0.0f, 0.0f);
        }
    }
